...
class _TimeCardState extends State<TimeCard> {
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          child: Text('Check the time people come to work today.'),
        ),
        SizedBox(
          height: MediaQuery.of(context).size.width * 0.03,
        ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Contact number : ${formatPhoneNumber(doc['tel'])}',
                                  style: GoogleFonts.mitr(
                                    textStyle: const TextStyle(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                //     ),
                                //   ),
                                //   child: const Text('Check work hours today'),
                                // ),
                                Spacer(),
                                ElevatedButton(
                                  onPressed: () async {
                                  ...
                                  child: const Text('Check work history:'),
                                ),
                                Spacer(),
                              ],
                            )
  ...
  timeStampFormat(Timestamp getTime) {
    ...
    String formattedDateTime =
        DateFormat('Date: dd-MM-yyyy Time: HH:mm:ss ').format(dateTime);

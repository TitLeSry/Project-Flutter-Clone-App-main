...
class ProgramerScreen extends StatefulWidget {
  const ProgramerScreen({super.key});

  @override
  State<ProgramerScreen> createState() => _ProgramerScreenState();
}

class _ProgramerScreenState extends State<ProgramerScreen> {
  int _currentIndex = 0;
